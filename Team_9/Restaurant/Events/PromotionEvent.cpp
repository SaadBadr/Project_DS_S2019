...
/*
	...
	if (orderPtr) {
		...
		if(orderPtr->GetRegion() == A_REG)
			pRest->AddtoVIPQueueA(new Order(orderPtr->GetID(), TYPE_VIP, A_REG, orderPtr->GetMoney(), orderPtr->GetDistance(), orderPtr->GetArrTime(), orderPtr->GetWT()));
		else if(orderPtr->GetRegion() == B_REG)
			pRest->AddtoVIPQueueA(new Order(orderPtr->GetID(), TYPE_VIP, B_REG, orderPtr->GetMoney(), orderPtr->GetDistance(), orderPtr->GetArrTime(), orderPtr->GetWT()));
		else if(orderPtr->GetRegion() == C_REG)
			pRest->AddtoVIPQueueA(new Order(orderPtr->GetID(), TYPE_VIP, C_REG, orderPtr->GetMoney(), orderPtr->GetDistance(), orderPtr->GetArrTime(), orderPtr->GetWT()));
		else
			pRest->AddtoVIPQueueA(new Order(orderPtr->GetID(), TYPE_VIP, D_REG, orderPtr->GetMoney(), orderPtr->GetDistance(), orderPtr->GetArrTime(), orderPtr->GetWT()));
